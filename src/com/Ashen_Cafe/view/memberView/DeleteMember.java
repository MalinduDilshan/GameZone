...
public class DeleteMember extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_delete.setToolTipText("click here to delete member profile");
        ...
        lbl_email.setBounds(20, 330, 130, 30);
        ...
        txt_email.setBounds(150, 330, 200, 30);
        ...
        getContentPane().add(jcb_memberid);
        jcb_memberid.setBounds(150, 80, 200, 30);
    ...
    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteActionPerformed
        ...
        if(String.valueOf(jcb_memberid.getSelectedItem()).equals("Select ID"))
            ...
            if( dialogResult ==  0 ){
              try{
                  if(id==1){
                    msg.warningMsg("You can't Delete this record", this);
                    clearAll();
                  }
                  else{
                dbm.delete(id);
